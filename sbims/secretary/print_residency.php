...
<head>
    ...
    <title>Certificate of Residency - <?php echo htmlspecialchars($certificate['certificate_id']); ?></title>
    <style>
...
<body>
    ...
    <div class="certificate-container">
        ...
        <div class="content">
            ...
            <div class="resident-info">
                ...
                Filipino citizen, is a bona fide resident of 
                <?php echo htmlspecialchars($certificate['purok']); ?>, Barangay Libertad, Municipality of Isabel, Province of Leyte.</p>
            </div>
            
            <p>This certification is issued upon the request of the above-named person for <strong><?php echo htmlspecialchars($certificate['purpose']); ?></strong> to certify his/her residency in this barangay for identification and other legal purposes.</p>
            
            <div class="residency-duration">
                <p>The above-named person has been a resident of Barangay Libertad for a considerable period of time and is listed in the official barangay registry.</p>
            </div>
        ...
        <div class="footer">
            ...
            <p><strong>OR Number:</strong> ___________ <strong>Amount Paid:</strong> ₱ 40.00</p>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            document.title = "Certificate of Residency - <?php echo htmlspecialchars($certificate['certificate_id']); ?>";
